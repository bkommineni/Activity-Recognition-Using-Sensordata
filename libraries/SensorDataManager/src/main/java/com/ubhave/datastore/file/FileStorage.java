...
{		
	...
	public JSONObject getJSONObject(final SensorData data, final DataFormatter formatter) throws DataHandlerException
	{
		JSONObject sensorDataJson = formatter.toJSONObject(data);
