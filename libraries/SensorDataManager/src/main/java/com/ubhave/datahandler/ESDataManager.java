...
public abstract class ESDataManager implements ESDataManagerInterface
{
	...
	public JSONObject getJSON(final SensorData data) throws DataHandlerException
	{
		DataFormatter formatter = null;
		JSONObject sensorDataJson = null;
		if (data != null)
		{
			formatter = DataFormatter.getJSONFormatter(context, data.getSensorType());
			sensorDataJson = formatter.toJSONObject(data);
		}
