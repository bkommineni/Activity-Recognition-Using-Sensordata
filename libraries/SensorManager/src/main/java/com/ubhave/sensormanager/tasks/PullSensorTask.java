...
public class PullSensorTask extends AbstractSensorTask
{
	...
	public void startSensingData() throws ESException
	{
		((PullSensor)sensor).senseStart();
	}

	public SensorData stopSensingData()
	{
		SensorData sensorData = ((PullSensor)sensor).senseStop();
		return sensorData;
	}
