...
public class AccelerometerSensor extends AbstractMotionSensor
{
	...
	public static AccelerometerSensor getSensorWithCustomConfig(Context context,SensorConfig sensorConfig) throws ESException
	{
		if (accelerometerSensor == null)
		{
			synchronized (lock)
			{
				if (accelerometerSensor == null)
				{
					accelerometerSensor = new AccelerometerSensor(context,sensorConfig);
				}
			}
		}
		return accelerometerSensor;
	...
	private AccelerometerSensor(final Context context, SensorConfig sensorConfig) throws ESException
	{
		super(context, Sensor.TYPE_ACCELEROMETER,sensorConfig);
	}
