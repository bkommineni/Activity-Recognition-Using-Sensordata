...
public abstract class AbstractPullSensor extends AbstractSensor implements PullSensor, SleepWindowListener
{
	...
	protected AbstractPullSensor(Context context, SensorConfig sensorConfig)
	{
		super(context,sensorConfig);
	}
	...
	public void senseStart() throws ESException
	{
		if (isSensing)
		{
			// sensing already started
