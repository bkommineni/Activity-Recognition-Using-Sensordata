...
print(len(frame))
frame = frame.drop_duplicates(subset=['User', 'Timestamp'])
print(len(frame))
...
fig, ax = plt.subplots()
rect1 = ax.bar(ind,means_walk,width=0.2,color='skyblue',align='center')
rect2 = ax.bar(ind+0.2,means_run,width=0.2,color='coral',align='center')
...
plt.savefig('./../images/AvgTimeDiff_walk_run.png',dpi=1000)